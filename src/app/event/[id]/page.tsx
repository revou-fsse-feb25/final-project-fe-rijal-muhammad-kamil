  ...
  return (
    <div className="text-white pt-50">
      ...
      <div className="flex flex-col lg:flex-row gap-14">
        <div className="w-full lg:w-1/2 h-[50vh] relative rounded-2xl group overflow-hidden">
          ...
          <div className="absolute top-2 right-2">
            <button onClick={handleFavoriteToggle} className={`w-12 h-12 rounded-full backdrop-blur-md border border-white/30 flex items-center justify-center transition-all duration-300 hover:scale-110 ${isFavorite ? "bg-red-500/80 text-white" : "bg-white/10 text-white hover:bg-white/20"}`}>
        ...
        <div className="w-full lg:w-1/2 relative">
          <div className="mb-4">
            <h1 className="text-2xl lg:text-3xl font-bold text-transparent bg-gradient-to-r from-white to-orange-600 bg-clip-text">{mockEventDetail.title}</h1>
          </div>
          ...
          {/* Date */}
          <div className="p-4 rounded-lg bg-(--color-surface-1) mb-4">
            <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button onClick={handleBuyTicket} className="font-bold text-white flex items-center justify-center gap-2 rounded-lg bg-orange-600 px-4 py-2 transition-all duration-150 ease-in hover:bg-orange-500  hover:scale-105">
              <Ticket size={24} />
      ...
      {/* Tab Navigation */}
      <div className="bg-gradient-to-r from-gray-800/90 to-gray-700/90 backdrop-blur-sm border-b border-gray-600/50">
        <div className="">
          <div className="flex gap-4">
            <button className="text-gray-700" onClick={() => setActiveTab("description")}>
              Deskripsi
            </button>
            <button className="text-gray-700" onClick={() => setActiveTab("terms")}>
              Syarat & Ketentuan
            </button>
            <button className="text-gray-700" onClick={() => setActiveTab("tickets")}>
              Tiket
            </button>
          </div>
        </div>
